YUI.add('yui2-yahoo', function(Y) { Y.use('yui2-yuiloader'); }, '3.8.0' ,{});
YUI.add('yui2-get', function(Y) { Y.use('yui2-yuiloader'); }, '3.8.0' ,{"requires": ["yui2-yahoo"]});
...
YAHOO.register("yuiloader", YAHOO.util.YUILoader, {version: "2.8.2r1", build: "7"});
    ...
    Y.YUI2 = YAHOO;
}, '2.8.2' ,{"supersedes": ["yui2-yahoo", "yui2-get"]});
