YUI.add('yui2-containercore', function(Y) { Y.use('yui2-container'); }, '3.8.0' ,{"requires": ["yui2-yahoo", "yui2-dom", "yui2-event"]});
        ...
        configButtons: function (type, args, obj) {
            ...
            if (Lang.isArray(aButtons)) {
                ...
                for (i = 0; i < nButtons; i++) {
                    ...
                    if (Button) {
                        if (oButton.type === 'link') {
                            oYUIButton = new Button({
                                label: oButton.text,
                                type: oButton.type,
                                href: '#'
                            });
                            oYUIButton.on('click', function(e){
...
}, '2.8.2' ,{"requires": ["yui2-yahoo", "yui2-dom", "yui2-event"], "supersedes": ["yui2-containercore"], "optional": ["yui2-animation", "yui2-dragdrop", "yui2-connection"]});
