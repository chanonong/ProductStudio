    ...
    while(elTarget && (elTag != "table")) {
        switch(elTag) {
            case "body":
                return;
            case "li":
                if (YAHOO.util.Dom.getAncestorByClassName(elTarget, 'yui-ac-container')) {
...
}, '2.8.2' ,{"requires": ["yui2-yahoo", "yui2-dom", "yui2-event", "yui2-datasource"], "optional": ["yui2-animation", "yui2-connection"]});
